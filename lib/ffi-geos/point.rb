  ...
  class Point < Geometry
    if FFIGeos.respond_to?(:GEOSGeomGetX_r)
      def get_x
        ...
        FFIGeos.GEOSGeomGetX_r(Geos.current_handle, ptr, double_ptr)
    ...
    if FFIGeos.respond_to?(:GEOSGeomGetY_r)
      def get_y
        double_ptr = FFI::MemoryPointer.new(:double)
        FFIGeos.GEOSGeomGetY_r(Geos.current_handle, ptr, double_ptr)
        double_ptr.read_double
      end
    else
      def get_y
    ...
    if FFIGeos.respond_to?(:GEOSGeomGetZ_r)
      def get_z
        double_ptr = FFI::MemoryPointer.new(:double)
        FFIGeos.GEOSGeomGetZ_r(Geos.current_handle, ptr, double_ptr)
        double_ptr.read_double
      end
    else
      def get_z
